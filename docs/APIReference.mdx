...
Utility function to infer a GraphQL field name from a schema or operation name. If the schema is an array or isArray is true, the field name will be pluralized.
